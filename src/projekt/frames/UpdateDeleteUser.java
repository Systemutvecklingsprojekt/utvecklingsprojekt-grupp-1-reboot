...
public class UpdateDeleteUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Uppdatera och ta bort en användare");
...
/**
 * Skapar variabler av alla SQL-frågor som behövs när en användare ska tas bort. I try:en körs dessa frågor och tar bort data
 * i databasen från den valda användaren.
 * @param evt 
 */
...
/**
 * Hämtar värde från tabell angående vald användare för att öppna rutan för redigering av användaren.
 * @param evt 
 */
...
/**
 * Kontrollerar att man valt en användare
 * Kontrollerar vald användare
 * @return 
 */
